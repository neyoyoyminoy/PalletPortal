...
class GlitchText(QWidget):
    ...
    def paintEvent(self, e):
        ...
        text_h = fm.height()  #full text height

        cx = self.width() // 2  #center x of widget
        cy = self.height() // 2  #center y of widget

        x = cx - text_w // 2  #top-left x for centered text
        y = cy + text_h // 2 - fm.descent()  #baseline y for centered text
...
class DemoWindow(QWidget):
    ...
    def keyPressEvent(self, e):
        ...
        #optional safety: escape exits immediately if you get stuck
...
if __name__ == "__main__":
    ...
    #w.show()  #uncomment this and comment fullscreen if you want windowed mode for debugging
