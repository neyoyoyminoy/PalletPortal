...
class LEDWorker(QThread):
    ...
    def __init__(self, num_leds=5, parent=None):
        ...
        self.to_pink_flash.connect(lambda: self._set_mode("pink_flash"))
...
class ShipScreen(QWidget):
    ...
    def _on_all_done(self):
        ...
        #reset workers for next run
        self._barcode_worker = None
        self._barcode_worker2 = None

        #delay so user sees results and removes usb
        QTimer.singleShot(3000, self._return_to_welcome)
    ...
    def _return_to_welcome(self):
        ...
        #restart led rainbow standby
        try:
            mw.leds.to_standby.emit()
        except Exception:
            pass 
